...
class SiglipAttention(nn.Module):
    ...
    def forward(self, hidden_states:torch.Tensor) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
        # states: [Batch_Size, Num_Heads, Num_Patches, Head_Dim]
        ...
        # Multiply the attention weights by the value_states. attn_output: [Batch_Size, Num_Heads, Num_Patches, Head_Dim]
        ...
        # [Batch_Size, Num_pathches, Embed_Dim]
...
class SiglipVisionModel(nn.Module):
    ...
    def forward(self, pixel_values) -> Tuple[torch.Tensor, torch.Tensor]:
